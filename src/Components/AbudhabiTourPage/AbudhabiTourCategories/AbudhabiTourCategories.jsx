...
import "./AbudhabiTourCategories.scss"
import { useState } from 'react';
import AbudhabiTourActivities from '../AbudhabiTourActivities/AbudhabiTourActivities';

export default function AbudhabiTourCategories() {
    let swiperRef = null;
    const [ selectedCategory, setSelectedCategory ] = useState("")
    return (
        <section>
            <div className="abudhabi-tour-categories">
                <div className="heading-section">
                    <div className="title">
                        <h3>Popular Tour & Activities</h3>
                    </div>
                    <div className="sub-title">
                        <h1>Explore the Best Experiences and<br/> Adventures in Abudhabi</h1>
                    </div>
                </div>
                <Swiper
                    spaceBetween={20}
                    ...
                    className="activities-grid-container"
                ...
                {/* <div className="popular-section-grid"> */}
                    {abudhabiTourCategory.map((service) => {
                        return (
                            <SwiperSlide 
                                key={service.id}
            ...
            <AbudhabiTourActivities selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory}/>
        </section>
    )
}