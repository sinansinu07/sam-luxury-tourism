...
import "./OutBoundDestinationHero.scss"
...
export default function OutBoundDestinationHero() {
    const images = outboundDestinations.map((ele) => {
        return ele.image
    });
    ...
    return (
        <section>
            <div className="outbound-destination-hero">
                <motion.div
                    // key={currentIndex}
                ...
                <motion.div 
                    ...
                    className="hero-content section-container">
                        <motion.h1 variants={childVariants} className="title">{outboundDestinations[currentIndex].title}</motion.h1>
                        <motion.p variants={childVariants} className="description">{outboundDestinations[currentIndex].description}</motion.p>
